...
<div class="max-w-2xl space-y-6">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-white/50">
            Perbarui role yang tampil pada bagian Hero.
        </p>
    </div>
    ...
    <form
        action="{{ route('admin.hero-roles.update', $heroRole) }}"
        method="POST"
    ...
    >
        ...
        <div>
            ...
            <input
                type="number"
                name="sort_order"
                value="{{ old('sort_order', $heroRole->sort_order) }}"
                min="0"
                required
        ...
        <label class="flex cursor-pointer items-center gap-3">
            <input
                ...
                name="is_visible"
                value="1"
                {{ old('is_visible', $heroRole->is_visible) ? 'checked' : '' }}
                class="h-4 w-4"
            >
